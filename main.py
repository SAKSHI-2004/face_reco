...
class Face_Recognition_System:
    def __init__(self,root):
        ...
        txt_username=Entry(login_frame,font=("times new roman",15),bg="#c0c9c5").place(x=50,y=160,width=300)

        lbl_pass=Label(login_frame,text="Password",font=("Andalus",15),bg="#f1f3f2",fg="#040401").place(x=60,y=200)
        txt_pass=Entry(login_frame,font=("times new roman",15),bg="#c0c9c5").place(x=50,y=240,width=300)

        btn_login=Button(login_frame,text="Log In",font=("Arial Rounded MT Bold",15),bg="#00B0F0",activebackground="#00B0F0",fg="white",cursor="hand2").place(x=50,y=300,width=300,height=35)
